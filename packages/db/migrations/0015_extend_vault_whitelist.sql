-- 0015_extend_vault_whitelist.sql
-- Extends the set_tenant_secret RPC's vendor whitelist to cover Wave 1
-- module integrations: Gmail (Email Triage), Twitter/LinkedIn/Medium
-- (Content Syndication). Meta + Stripe were already whitelisted in 0007.
--
-- Same function body as 0007 — only the kind whitelist changed.
